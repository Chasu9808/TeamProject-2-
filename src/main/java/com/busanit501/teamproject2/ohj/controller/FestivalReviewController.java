...
import com.busanit501.teamproject2.ohj.service.FestivalReviewService;
...
public class FestivalReviewController {
    ...
    public Map<String,Long> register(
            ...
            @Valid @RequestBody FestivalReviewDTO festivalReviewDTO,
            BindingResult bindingResult) throws BindException {
        log.info("ReplyController의 register ,replyDTO 확인: "+festivalReviewDTO);
...
//        Map<String,Long> resultMap = Map.of("rno",123L);
        ...
        Long festival_review_id = festivalReviewService.register(festivalReviewDTO);
        resultMap.put("festival_review_id",festival_review_id);
