...
public class FestivalSearchImpl extends QuerydslRepositorySupport implements FestivalSearch {
  ...
  public FestivalSearchImpl() {
    super(Festival.class);
  }

  @Override
  public Page<Festival> search(Pageable pageable) {
    // Querydsl 이용하는 기본 문법
    QFestival board = QBoard.board;
    ...
    booleanBuilder.or(festival.festivalName.contains("1"));
    booleanBuilder.or(festival.content.contains("1"));
